...
<body>
  ...
  <script type="text/javascript">
    ...
    // dp.onEventResized = function (args) {
      // var diff = args.newEnd.getMinutes() - args.newStart.getMinutes() + (args.newEnd.getHours() - args.newStart.getHours()) * 60;
      // if(diff > 180) {
    ...
    var switcher = new DayPilot.Switcher({
      ...
      onChanged: function(args) {
        args.room = "Hartford IT Suite";
        console.log(args);
        switcher.events.load("calendar/calendar_events_hartford.php");
      }
    });
